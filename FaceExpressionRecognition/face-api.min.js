! function(t, e) {
    ...
    var uf = Object.freeze({
        ...
        drawEmociones: function(o, t, i, a) {
        ...
        drawFaceExpressions: function(o, t, i, a) {
            ...
            void 0 === i && (i = .1), (Array.isArray(t) ? t : [t]).forEach(function(t) {
                ...
                num++;
                console.log(num);
                //emociones = t.expression + " " + t.probability;
                emociones.push(t.expressions);
                //console.log(emociones);
                document.querySelector("textarea").value=JSON.stringify(emociones);
                var n = e.asSortedArray().filter(function(t) {
                        //emociones = t.expression + " " + t.probability;
                        //emociones[num]= t.expression + t.probability;
                        //console.log(emociones);
